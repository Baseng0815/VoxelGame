...
bool Chunk::positionInRange(glm::vec3 position) {
	return position.x >= 0 && position.x < Definitions::CHUNK_SIZE
		&& position.y >= 0 && position.y < Definitions::CHUNK_HEIGHT
		&& position.z >= 0 && position.z < Definitions::CHUNK_SIZE;
}
