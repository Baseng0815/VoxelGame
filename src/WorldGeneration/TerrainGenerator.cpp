...
TerrainGenerator::TerrainGenerator() {
  m_biomes.emplace_back(BiomeId::BIOME_FLAT, BlockId::BLOCK_GRASS,
                        BlockId::BLOCK_DIRT, 1, 3);
  m_biomes.emplace_back(BiomeId::BIOME_FLAT_TERRAIN, BlockId::BLOCK_GRASS,
                        BlockId::BLOCK_DIRT, 1, 4);
  m_biomes.emplace_back(BiomeId::BIOME_DESERT, BlockId::BLOCK_SAND,
                        BlockId::BLOCK_SAND, 1, 4);
  m_biomes.emplace_back(BiomeId::BIOME_BEACH, BlockId::BLOCK_SAND,
                        BlockId::BLOCK_SAND, 1, 4);
  m_biomes.emplace_back(BiomeId::BIOME_OCEAN, BlockId::BLOCK_SAND,
                        BlockId::BLOCK_SAND, 1, 3);
}
...
void TerrainGenerator::createBlocks(GenerationData *data,
                                    int **heightMap) const {
