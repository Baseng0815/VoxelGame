...
void ItemSystem::spawnItem(const glm::vec3 &position, const BlockId &block) {
    ...
    renderComponent.geometry = &Geometry{vertices, indices};
}
...
void ItemSystem::createItemGeometry(std::vector<Vertex> &vertices, std::vector<unsigned int> &indices, const BlockUVs &uvs) {
    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, -0.25f}, glm::vec3{-1, 0, 0}, uvs[4][0]);
    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, 0.25f}, glm::vec3{-1, 0, 0}, uvs[4][1]);
    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, 0.25f}, glm::vec3{-1, 0, 0}, uvs[4][2]);
    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, -0.25f}, glm::vec3{-1, 0, 0}, uvs[4][3]);

    vertices.emplace_back(glm::vec3{0.25f, 0.25f, 0.25f}, glm::vec3{1, 0, 0}, uvs[2][0]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, -0.25f}, glm::vec3{1, 0, 0}, uvs[2][1]);
    vertices.emplace_back(glm::vec3{0.25f, 0.25f, -0.25f}, glm::vec3{1, 0, 0}, uvs[2][2]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, 0.25f}, glm::vec3{1, 0, 0}, uvs[2][3]);

    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, 0.25f}, glm::vec3{0, -1, 0}, uvs[5][0]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, -0.25f}, glm::vec3{0, -1, 0}, uvs[5][1]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, 0.25f}, glm::vec3{0, -1, 0}, uvs[5][2]);
    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, -0.25f}, glm::vec3{0, -1, 0}, uvs[5][3]);

    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, -0.25f}, glm::vec3{0, -1, 0}, uvs[0][0]);
    vertices.emplace_back(glm::vec3{0.25f, 0.25f, 0.25f}, glm::vec3{0, -1, 0}, uvs[0][1]);
    vertices.emplace_back(glm::vec3{0.25f, 0.25f, -0.25f}, glm::vec3{0, -1, 0}, uvs[0][2]);
    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, 0.25f}, glm::vec3{0, -1, 0}, uvs[0][3]);

    vertices.emplace_back(glm::vec3{0.25f, 0.25f, -0.25f}, glm::vec3{0, 0, -1}, uvs[3][0]);
    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, -0.25f}, glm::vec3{0, 0, -1}, uvs[3][1]);
    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, -0.25f}, glm::vec3{0, 0, -1}, uvs[3][2]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, -0.25f}, glm::vec3{0, 0, -1}, uvs[3][3]);

    vertices.emplace_back(glm::vec3{-0.25f, 0.25f, 0.25f}, glm::vec3{0, 0, -1}, uvs[1][0]);
    vertices.emplace_back(glm::vec3{0.25f, -0.25f, 0.25f}, glm::vec3{0, 0, -1}, uvs[1][1]);
    vertices.emplace_back(glm::vec3{0.25f, 0.25f, 0.25f}, glm::vec3{0, 0, -1}, uvs[1][2]);
    vertices.emplace_back(glm::vec3{-0.25f, -0.25f, 0.25f}, glm::vec3{0, 0, -1}, uvs[1][3]);
